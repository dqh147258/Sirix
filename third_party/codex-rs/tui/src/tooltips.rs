...
const APP_TOOLTIP: &str = "Try the **Sirix App** for a synced desktop workflow.";
const FAST_TOOLTIP: &str = "*New* Use **/fast** to enable our fastest inference at 2X plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Sirix App**.";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Sirix.";
const FREE_GO_TOOLTIP: &str =
    "*New* Sirix is ready with your configured providers, models, MCP servers, and skills.";
...
/// Pick a random tooltip to show to the user when starting Sirix.
...
[[announcements]]
content = "Welcome to Sirix! Check out the new onboarding flow."
