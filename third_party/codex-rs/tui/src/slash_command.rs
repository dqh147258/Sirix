...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Sirix",
            ...
            // SlashCommand::Undo => "ask Sirix to undo a turn",
            SlashCommand::Quit | SlashCommand::Exit => "exit Sirix",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Copy => "copy the latest Sirix output to your clipboard",
