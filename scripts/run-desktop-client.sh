...
API_BASE_URL=${SIRIX_API_BASE_URL:-http://${SERVER_HOST}:8080}
DESKTOP_HOST=${SIRIX_DESKTOP_SERVER_HOST:-127.0.0.1}
DESKTOP_PORT_START=${SIRIX_DESKTOP_SERVER_PORT_START:-9700}
DESKTOP_PORT_END=${SIRIX_DESKTOP_SERVER_PORT_END:-9710}
UPDATE_DEPS=false
ARGS=()
